...
extern "C" {
    ...
    __device__ double *sigma;
    __constant__ double lambda[NFUNC];
    __constant__ double bias[NFUNC];
    __constant__ double o[NFUNC][NREAL];
    __constant__ double g[NREAL][NREAL];
